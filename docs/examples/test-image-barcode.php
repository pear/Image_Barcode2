...
<div class="test">
    <h2>Ean13 (png):</h2>
    <img src="barcode_img.php?num=1234567891231&type=ean13&imgtype=png"
        alt="PNG: 1234567891231" title="PNG: 1234567891231"/>
</div>

<div class="test">
    <h2>Ean8 (png):</h2>
    <img src="barcode_img.php?num=12345670&type=ean8&imgtype=png"
        alt="PNG: 12345670" title="PNG: 12345670"/>
</div>

<div class="test">
    <h2>Code39 (png):</h2>
    <img src="barcode_img.php?num=BARCODE&type=Code39&imgtype=png"
        alt="PNG: BARCODE" title="PNG: BARCODE"/>
</div>

<div class="test">
    <h2>UPC-A (png):</h2>
    <img src="barcode_img.php?num=123456789128&type=upca&imgtype=png"
        alt="PNG: 123456789128" title="PNG: 123456789128"/>
</div>

<div class="test">
    <h2>UPC-E (png):</h2>
    <img src="barcode_img.php?num=01507113&type=upce&imgtype=png"
        alt="PNG: 12345678" title="PNG: 12345678"/>
</div>

<div class="test">
    <h2>Code128 (png):</h2>
    <img src="barcode_img.php?num=barcode&type=code128&imgtype=png"
        alt="PNG: barcode" title="PNG: barcode"/>
</div>

<div class="test">
    <h2>PostNet (png):</h2>
    <img src="barcode_img.php?num=202609900&type=postnet&imgtype=png"
